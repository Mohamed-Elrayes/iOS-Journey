      ...
      VStack {
        Image(restaurant.image)
          ...
          .overlay {
            ...
            .frame(
              minWidth: /*@START_MENU_TOKEN@*/0/*@END_MENU_TOKEN@*/, maxWidth: .infinity,
